            ...
            Quando eu selecionar a cor "rosa", o tamanho "P" e a quantidade "2"
            ...
            Quando que eu tenha selecionado cor , tamanho e quantidade e clicar no botão "limpar"
            Então o sistema deve voltar ao estagio original e nenhuma opção deve permanecer selecionada
